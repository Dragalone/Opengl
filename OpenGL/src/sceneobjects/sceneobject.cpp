...
SceneObject::SceneObject()
{
	...
	PointLight pl;
	pl.position = glm::vec3(0.8f, 0.8f, 2.0f);
    pl.constant = 1.0f;
    pl.linear = 0.0f;
    pl.quadratic = 0.01f;
    ...
    sl.linear = 0.0f;
    sl.quadratic = 0.01f;
    sl.ambient = glm::vec3(0.75f, 0.75f, 0.75f);
    sl.diffuse = glm::vec3(0.5f, 0.5f, 0.5f);
    sl.specular = glm::vec3(0.2f, 0.2f, 0.2f);
    sl.cutOff = cos(glm::radians(20.0f));
    sl.outerCutOff = cos(glm::radians(40.0f));
